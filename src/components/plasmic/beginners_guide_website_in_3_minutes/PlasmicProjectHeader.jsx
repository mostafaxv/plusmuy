...
import sty from "./PlasmicProjectHeader.module.css"; // plasmic-import: tWoB9nu4fliM/css
...
function PlasmicProjectHeader__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.columns__wXJjp)}>
        <div className={classNames(projectcss.all, sty.column__seqsD)}>
          <div
            className={classNames(
              projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.column__mItN)}>
          <div className={classNames(projectcss.all, sty.columns__us9Mx)}>
            <div className={classNames(projectcss.all, sty.column__gvM33)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox___2Sw4A)}>
                {renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.column___7Vql)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__siBqw)}>
                {renderPlasmicSlot({
